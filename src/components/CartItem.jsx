            ...
            <div style={{marginBottom: "1rem"}} className="row">
                <div className="col-5">
                    <div className="d-flex">
                        <img style={{ height: "8rem" }} src="https://img.mytheresa.com/1094/1236/90/jpeg/catalog/product/b3/P00737552.jpg" className="img-fluid" alt="" />
                        <div style={{ padding: "1rem" }}>
                            <h6 style={{ fontWeight: "600", marginBottom: "0", color: "#363636" }}> Gucci Black Loafer </h6>
                            <small style={{ color: "rgb(100, 100, 100)" }}>Gucci</small>
                            <p style={{ marginTop: "0.6rem", color: "#585858" }}>
                                Size <span style={{ color: "#464646", fontWeight: "500" }}> 7</span>
                            </p>
                        ...
                        <div className="col-4">
                            <center>
                                ...
                                <div>
                                    ...
                                    <span style={{ padding: "0.5rem 0.8rem 0.5rem 0.8rem", border: "1px rgb(198, 198, 198) solid" }}>2</span>
                                    <button style={{ border: "none" }} className="btn btn-outline-dark btn-sm">
